...
**Recommendation:** Target retention efforts at the Sales Representative role specifically, rather than the Sales department broadly — a department wide fix would overspend on roles that aren't actually at risk.

### 2. What's driving attrition is it workload?
**Method:** Crosstabbed attrition rate against OverTime status (Yes/No).
